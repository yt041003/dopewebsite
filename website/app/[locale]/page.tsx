...
export default async function Page({params}:{params:Promise<{locale:string}>}){
 ...
 const data={'@context':'https://schema.org','@type':'WebSite',name:'Twynzo',alternateName:'TWYNZO',url:siteUrl(),publisher:{'@type':'Organization',name:'Twynzo',url:siteUrl(),logo:siteUrl()+'/twynzo-icon.png'},inLanguage:['zh-Hant','en']};
